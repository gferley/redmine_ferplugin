...
module FerTimelogControllerPatch
  def self.included(base) # :nodoc:
    base.send(:include, InstanceMethods)

    base.class_eval do
      alias_method_chain :create, :user_selection
    end
  end
  
  module InstanceMethods  
		def create_with_user_selection
...
TimelogController.send(:include, FerTimelogControllerPatch)
